...
console.log('- Keep your secret key secure and never commit it to version control');
console.log('- The longer the key, the more secure it is (64+ characters recommended)');
console.log('- You can also use online generators like: https://generate-secret.vercel.app/64');