...
async function testWordPressConnection() {
  ...
  if (!wpUrl) {
    ...
    console.log('📝 Please update your .env.local file with your WordPress Local site URL');
    console.log('   Example: WORDPRESS_API_URL=http://your-site-name.local/graphql');
    return;
  }
  ...
  try {
    ...
    if (error.message.includes('ENOTFOUND') || error.message.includes('ECONNREFUSED')) {
      ...
      console.log('   2. Check that the site URL in .env.local matches your WordPress Local site');
      ...
      console.log('   2. Check the wordpress-local-config.php file for setup instructions');
    } else {
