...
const featuredServices = [
  ...
  },
  {
    ...
    description:
      'Complete online stores with secure payments, inventory management, and seamless shopping experiences.',
    icon: '🛒',
    features: [
      'Payment Integration',
...
const featuredBlogPosts = [
  ...
  },
  {
    ...
    excerpt:
      'Learn how to create inclusive designs that work for everyone, including users with disabilities.',
    author: {
      name: 'Michael Chen',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                ...
                who understand that great technology should serve your business
                goals. Our team combines technical expertise with creative
                vision to deliver solutions that make a real impact.
              </p>
                ...
                {[
                  {
                    title: 'Expert Team',
                    description:
                      'Skilled developers and designers with years of industry experience.',
                  },
                  {
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-trimax rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg
                        className="w-3 h-3 text-trimax-foreground"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
        ...
        <div className="container mx-auto px-4">
          <div className="bg-trimax text-trimax-foreground rounded-2xl p-8 md:p-16 text-center">
            ...
            <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              ...
              vision to life with our expertise and innovative solutions.
            </p>
